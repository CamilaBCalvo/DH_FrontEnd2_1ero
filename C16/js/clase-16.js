...
boton.addEventListener("click", () => {
  ...
  consultaAsincrona("endpoint").then((respuesta) => renderizarElementos(respuesta)).catch(error => console.error('se rompio todo', error));
});
...
function renderizarElementos(listado) {
  ...
  let comentarios = listado.map(comentario =>{
    return `
  ...
  document.querySelector('.comentarios').innerHTML = comentarios.join('')
}
